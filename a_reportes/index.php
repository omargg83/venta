...
<form id='consulta_avanzada' action='' data-destino='a_reporte/lista' data-div='resultado'  autocomplete='off'>
  <div class='container' >
    <div class="alert alert-success" role="alert">
      <h4 class="alert-heading">POLIZAS EMITIDAS</h4>
      <div class='row'>
        <div class='col-sm-3'>
            <label><b>Del</b></label>
